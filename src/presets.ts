...
const normalTasks: Task[] = [
  { id: 't1', name: '起床 & 喝杯水', startTime: '07:30', duration: 15, category: '健康', icon: 'Sunrise', color: '#f59e0b', enabled: true },
  { id: 't2', name: '营养早餐', startTime: '08:00', duration: 30, category: '健康', icon: 'Coffee', color: '#f59e0b', enabled: true },
  { id: 't3', name: '深度工作', startTime: '09:00', duration: 120, category: '工作', icon: 'Briefcase', color: '#3b82f6', enabled: true },
  { id: 't4', name: '休息 & 喝水', startTime: '11:00', duration: 15, category: '健康', icon: 'GlassWater', color: '#06b6d4', enabled: true },
  ...
  { id: 't9', name: '泌尿系统保健运动', startTime: '15:30', duration: 30, category: '健康', icon: 'Footprints', color: '#10b981', enabled: true },
  { id: 't10', name: '下午工作', startTime: '16:00', duration: 90, category: '工作', icon: 'Briefcase', color: '#3b82f6', enabled: true },
  { id: 't11', name: '晚餐', startTime: '18:00', duration: 45, category: '健康', icon: 'Utensils', color: '#f59e0b', enabled: true },
  { id: 't12', name: '有氧运动', startTime: '19:00', duration: 60, category: '健康', icon: 'Dumbbell', color: '#10b981', enabled: true },
  { id: 't13', name: '自由时间', startTime: '20:00', duration: 60, category: '休息', icon: 'Music', color: '#ec4899', enabled: true },
  { id: 't14', name: '泡脚养生', startTime: '21:00', duration: 30, category: '健康', icon: 'Droplets', color: '#06b6d4', enabled: true },
  { id: 't15', name: '准备睡觉', startTime: '21:30', duration: 30, category: '休息', icon: 'Moon', color: '#6366f1', enabled: true },
  { id: 't16', name: '睡觉', startTime: '22:00', duration: 420, category: '休息', icon: 'BedDouble', color: '#475569', enabled: true },
];
